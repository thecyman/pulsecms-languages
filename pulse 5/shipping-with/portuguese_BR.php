...
$lang_form_error_recapcha = 'reCAPTCHA falhou';

$lang_form_comment = 'Comente';
$lang_form_gdpr    = 'GDPR';
$lang_form_phone   = 'Telefone';
$lang_form_name    = 'Nome';
$lang_form_email   = 'O email';

// Mailchimp
$lang_mailchimp_subscribe_label = 'Assine nossa lista de discussão';
$lang_mailchimp_email_address   = 'Endereço de e-mail';
$lang_mailchimp_subscribe       = 'Se inscrever';
...
$lang_settings_geoip_api_key         = 'GeoIP serviço API KEY';
$lang_settings_geoip_api_key_tooltip = 'GeoIP serviço API KEY';
$lang_settings_geoip_service         = 'GeoIP serviço';
...
$lang_settings_ogp_twitter_creator          = 'Conta pessoal do Twitter';
$lang_settings_ogp_twitter_creator_tooltip  = 'Conta pessoal do Twitter';
$lang_settings_ogp_twitter_username         = 'Conta do Twitter para o site';
$lang_settings_ogp_twitter_username_tooltip = 'Conta do Twitter para o site';
...
$lang_settings_blog_blog_flag_show_teaser_image = 'Exibir a imagem de visualização';
...
# User Group List
$lang_settings_title_user_group_list  = 'Lista de grupos de usuários';
$lang_settings_manage_user_group_list = 'Gerenciar lista de grupos de usuários';

$lang_settings_user_group_list_title    = 'Gerenciar Grupos';
$lang_settings_user_group_list_subtitle = 'Adicionar / Apagar grupos';

$lang_settings_user_group_list_group_name  = 'Nome do grupo';
$lang_settings_user_group_list_permissions = 'Permissões de acesso';
...
$lang_settings_integrate_ecommerce = 'Integrar comércio';

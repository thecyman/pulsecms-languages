...
$lang_gal_caption_gallery = "Inserisci qui la tua didascalia";
$lang_gal_filename = "Nome file";
$lang_gal_dimensions = "Dimensioni in px";
$lang_gal_size = "Dimensioni in KB";
$lang_gal_img = "IMG";
$lang_gal_link = "Link";
...
$lang_error_file_exists = 'Un file con questo nome gia esiste in questa cartella.';
...
$lang_blog_back_button = 'Indietro';
$lang_blog_older = 'Notizie precedenti';
$lang_blog_newer = 'Notizie recenti';
$lang_blog_error_folder = "Non puoi creare una cartella in Blog";
$lang_blog_tool_tip = "I post del blog sono ordinati per numero, un numero maggiore indica un post piu recente.";
...
$lang_blog_import_page_max = 'Numero massimo di pagine';
...
$lang_form_error2b = ' e troppo lungo';
$lang_form_subject_line = 'Contatti';
$lang_form_email_sent = 'Email inviata ';
$lang_form_sent_button = 'Invia';

$lang_auto_thank_contact = 'Grazie abbiamo ricevuto il tuo messaggio, ti risponderemo presto';

// Stats

$lang_stats_today = "Visitatori";
$lang_stats_refers = "Maggiori referral";
$lang_stats_pages = "Pagine piu visitate";
